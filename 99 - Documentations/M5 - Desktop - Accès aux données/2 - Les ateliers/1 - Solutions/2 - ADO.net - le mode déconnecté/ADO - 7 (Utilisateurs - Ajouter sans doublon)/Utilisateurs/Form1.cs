...
namespace Utilisateurs
{
    ...
    public partial class frmMain : Form
    {
        ...
        private void btAjouter_Click(object sender, EventArgs e)
        {
            ...
            var id = _db.InsertIfNotExistUtilisateur(txtNom.Text, txtPrenom.Text, dtpNaiss.Value);
            btActualiser.PerformClick();
        ...
        private void btModifier_Click(object sender, EventArgs e)
        {
            ...
            if (current is not null)
            {
                ...
                // Requête optimiste
                var nb = _db.UpdateOptimistUtilisateur(current.Id, txtNom.Text, txtPrenom.Text, dtpNaiss.Value, current.Nom, current.Prenom, current.DtNaiss);

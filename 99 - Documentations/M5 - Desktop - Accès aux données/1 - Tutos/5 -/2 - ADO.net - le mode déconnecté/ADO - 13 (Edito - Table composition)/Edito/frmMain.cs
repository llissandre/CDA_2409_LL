...
namespace Edito
{
    public partial class frmMain : Form
    {
        ...
        private void BSJournauxCompo_CurrentChanged(object sender, EventArgs e)
        {
            ...
            if (journal != null)
            {
                ...
                var articlesIn = _db.GetArticlesInJournal(journal.IdJournal);
                ...
                var articlesNotIn = _db.GetArticlesNotInJournal(journal.IdJournal);
                foreach (Article a in articlesNotIn)
                    _articlesNotInJournal.Add(a);
            }
        }

        private void btJournalCompositionActualiser_Click(object sender, EventArgs e)
        {
            // Sauvegarde du current
        ...
        private void btJournalCompositionExclure_Click(object sender, EventArgs e)
        {
            ...
            {
                var nb = _db.DeleteComposition(currentJournal.IdJournal, currentArticle.IdArticle);
            }

            btJournalCompositionActualiser.PerformClick();
        }

        private void btJournalCompositionInclure_Click(object sender, EventArgs e)
        {
            Journal currentJournal = BSJournauxCompo.Current as Journal;
            ...
            if (currentJournal != null && currentArticle != null)
            {
                var nb = _db.InsertComposition(currentJournal.IdJournal, currentArticle.IdArticle);
            }

    ...
    public partial class frmMain : Form
    {
        ...
        private void btArticleSupprimer_Click(object sender, EventArgs e)
        {
            ...
            if (current is not null)
            {
                ...
                {
                    // Requête qui vérifie la présence dans la table composition
        ...
        private void btJournalSupprimer_Click(object sender, EventArgs e)
        {
            ...
            if (current is not null)
            {
                ...
                {
                    // Suppression du journal dans la table Composition
                    var nb = _db.DeleteAllJournauxInComposition(current.IdJournal);

                    // Suppression du journal
                    nb = _db.DeleteJournal(current.IdJournal);

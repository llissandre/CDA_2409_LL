...
namespace Age
{
    ...
    ///     - Gestion d'un texte par défaut. Evenements 'Enter' et 'Leave' des champs texte (sans utiliser la propriété PlaceHolderText)
    ///     
    ///</summary>
    public partial class frmMain : Form
    {
        ...
        #region Partie 3 - Gestion des champs vides
